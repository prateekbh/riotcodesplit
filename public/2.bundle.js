...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('browse', '<ul class="productgrid"> <li class="product" each="{product in products}"> <a href="/riotcodesplit/#product/{category}/{product.name}"> <img class="productpic" riot-src="https://shop.polymer-project.org{product.image}" height="300" width="300"> <div class="producttitle">{product.title}</div> </a> </li> </ul>', '', '', function(opts) {
			this.products=[];
			this.category='';
